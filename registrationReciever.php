...
if (isset($_POST['btnRegSubmit'])) {
	...
	if($booleanValidations==true){
		registerUserInDB($username, $password, $email, $mobile, $address, $zip, "reciever", $hospCode);
	}
}
?>
	  <input type="text" name="txtRegHospCode" placeholder="Hospital Id" style="margin-bottom: 10px;" required="true"/><br>	
